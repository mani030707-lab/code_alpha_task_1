...
//  SUPABASE CONFIG
// ============================================================
const supabaseUrl = "https://iqguacldwqnbyakramqd.supabase.co";
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlxZ3VhY2xkd3FuYnlha3JhbXFkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzM5MDg4ODksImV4cCI6MjA4OTQ4NDg4OX0.SHYXZ2d82XPiCIugkWWyATeBPwFC8t0eT0J5ZhvLTNs";
...
const products = [
  ...
  { id: "54e0eccd-8f36-462b-b68a-8182611d9add", image: "images/products/6-piece-white-dinner-plate-set.jpg", name: "6-Piece White Dinner Plate Set", rating: { stars: 4, count: 9.0 }, pricePaise: 79000, keywords: ["plates", "glassware"] },
  ...
  { id: "b86ae3ff-f612-4832-b62c-b20d2ed0c94e", image: "images/products/bathroom-rug.jpg", name: "Bathroom Rug", rating: { stars: 4, count: 9.0 }, pricePaise: 400000, keywords: ["bathroom", "rug"] },
  { id: "aaa2406c-b5e6-4360-a153-23d6c4a07e37", image: "images/products/black-2-slot-toaster.jpg", name: "Bread Toaster", rating: { stars: 3.5, count: 7.0 }, pricePaise: 369000, keywords: ["toaster", "kitchen"] },
  { id: "a42e22c2-7896-4a78-9fdc-8bff8d3bf7d7", image: "images/products/blackout-curtains-black.jpg", name: "Blackout Curtains - Black", rating: { stars: 4.5, count: 9.8 }, pricePaise: 12099, keywords: ["curtains", "window"] },
  { id: "a3f9c1e2-7b4d-4c8a-9f21-6e3d5b8a1c90", image: "images/products/coffeemaker-with-glass-carafe-black.jpg", name: "Coffeemaker with Glass Carafe", rating: { stars: 4, count: 9.5 }, pricePaise: 500000, keywords: ["coffeemaker", "kitchen"] },
  { id: "9f1c2a7e-3d4b-4b8f-9c21-7e6a5d2c8f10", image: "images/products/cotton-bath-towels-teal.webp", name: "Cotton Bath Towel", rating: { stars: 4, count: 9.3 }, pricePaise: 50000, keywords: ["towel", "bath"] },
  { id: "c3a7e9b2-6f1d-4a5c-8b32-1d7e9f4a2c63", image: "images/products/countertop-blender-64-oz.jpg", name: "Countertop Blender 64oz", rating: { stars: 3.5, count: 8.5 }, pricePaise: 389999, keywords: ["blender", "juicer", "kitchen"] },
  { id: "e8b4c1d9-2a7f-4c6e-9d10-5f3a8b7c2e41", image: "images/products/duvet-cover-set-blue-twin.jpg", name: "Blue Duvet Cover Set", rating: { stars: 4.5, count: 9.8 }, pricePaise: 50326, keywords: ["bed sheet", "duvet"] },
  { id: "a6d9f3c2-8b1e-4f7a-9c54-2e7d1b8a6f30", image: "images/products/electric-glass-and-steel-hot-water-kettle.webp", name: "Electric Glass & Steel Kettle", rating: { stars: 4, count: 9.0 }, pricePaise: 200000, keywords: ["kettle", "kitchen"] },
  { id: "b1e7c4a9-3d2f-4a8c-8f21-6c9d5e2a7b48", image: "images/products/floral-mixing-bowl-set.jpg", name: "Floral Mixing Bowl Set", rating: { stars: 3.0, count: 8.0 }, pricePaise: 19999, keywords: ["bowl", "kitchen"] },
  { id: "d4f8a2c1-7b9e-4e6a-9a32-1f5c8d7b2e60", image: "images/products/men-athletic-shoes-green.jpg", name: "Men's Athletic Shoes - Green", rating: { stars: 2.0, count: 7.5 }, pricePaise: 150000, keywords: ["shoes", "mens wear"] },
  { id: "f2c9e1a7-6d4b-4b5f-8c73-9a1e6d3b7c52", image: "images/products/men-golf-polo-t-shirt-blue.jpg", name: "Men's Polo T-Shirt Blue", rating: { stars: 4.0, count: 8.0 }, pricePaise: 50000, keywords: ["tshirt", "mens wear"] },
  { id: "7e3a9c1d-5b2f-4d8e-9f14-2c6a7b8d1e39", image: "images/products/variations/liquid-laundry-detergent-plain.jpg", name: "Liquid Laundry Detergent", rating: { stars: 3.5, count: 8.0 }, pricePaise: 50000, keywords: ["detergent", "laundry"] },
  ...
  { id: "5a7d2c9e-1f8b-4e3a-9c62-7d1e5b8a3f44", image: "images/products/variations/men-chino-pants-beige.jpg", name: "Men's Chino Pants", rating: { stars: 4.0, count: 9.8 }, pricePaise: 60000, keywords: ["pants", "mens wear"] },
  { id: "8b2e7c4a-6d1f-4a9e-8f35-2a7c9d1b6e53", image: "images/products/variations/Iphone14.jpg", name: "iPhone 14", rating: { stars: 5.0, count: 10 }, pricePaise: 15000000, keywords: ["phones", "iphone", "mobiles"] },
  { id: "1d9a6f3c-7b4e-4c8a-9e20-6f2b7d5a8c31", image: "images/products/variations/oneplus.jpg", name: "OnePlus 11R 5G", rating: { stars: 5.0, count: 9.8 }, pricePaise: 5000000, keywords: ["mobiles", "phones", "oneplus"] },
  { id: "3f7c1a9e-8d2b-4e6a-8c41-9b5d2a7e6f80", image: "images/products/variations/round-sunglasses-black.jpg", name: "Round Sunglasses - Black", rating: { stars: 4.5, count: 9.5 }, pricePaise: 45000, keywords: ["sunglasses", "accessories"] },
  { id: "6a1e8c2f-4d9b-4b7c-9a53-1c8d7e2f5b62", image: "images/products/variations/plain-hooded-fleece-sweatshirt-yellow.jpg", name: "Hooded Sweatshirt", rating: { stars: 4.5, count: 9.0 }, pricePaise: 35000, keywords: ["hoodie", "sweatshirt"] },
  { id: "4c9b2a7e-1f6d-4a8e-8b24-7d3a9c1e5f77", image: "images/products/variations/men-slim-fit-summer-shorts-gray.jpg", name: "Men's Slim Fit Summer Shorts", rating: { stars: 3.5, count: 8.5 }, pricePaise: 39900, keywords: ["shorts", "mens wear"] }
];
...
function updateCartBadge() {
  ...
  document.querySelectorAll(".cart-quantity, .js-items-count-header").forEach(el => { if (el) el.textContent = total; });
}
...
async function loadCartFromDB() {
  ...
  const { data, error } = await db.from("cart_items").select("*").eq("user_id", currentUser.id);
...
async function syncCartItemToDB(productId) {
  ...
  if (!item) {
    await db.from("cart_items").delete().eq("user_id", currentUser.id).eq("product_id", productId);
  } else {
    await db.from("cart_items").upsert({
      user_id: currentUser.id, product_id: productId,
      quantity: item.quantity, delivery_option_id: item.deliveryOptionId
...
async function updateQuantity(productId, newQty) {
  const item = cart.find(i => i.productId === productId);
  if (item) { item.quantity = newQty; await syncCartItemToDB(productId); }
}
...
async function placeOrder() {
  ...
  const itemRows = cart.map(cartItem => {
    ...
    totalPaise    += (product ? product.pricePaise : 0) * cartItem.quantity + delivOpt.pricePaise;
    return {
  ...
  const { data: orderData, error: orderErr } = await db
    .from("orders")
    .insert({ user_id: currentUser.id, placed_date: new Date().toISOString(), total_paise: totalPaise, status: "active" })
    .select().single();
 
  if (orderErr) { console.error("Order error:", orderErr); alert("Could not place order."); return; }
 
  await db.from("order_items").insert(itemRows.map(r => ({ ...r, order_id: orderData.id })));
  await clearCart();
  updateCartBadge();
  navigateTo("orders");
}
...
async function loadOrders() {
  if (!currentUser) return [];
  const { data: orders, error } = await db.from("orders").select("*").eq("user_id", currentUser.id).order("placed_date", { ascending: false });
    ...
    html += `
      <div class="product-container">
        <div class="product-image-container">
          <img class="product-image" src="${product.image}" alt="${product.name}" onerror="this.src=''">
        </div>
...
function renderOrderSummary() {
  ...
  if (cart.length === 0) {
    container.innerHTML = `<div style="padding:30px;text-align:center;"><p style="font-size:18px;margin-bottom:15px;">Your cart is empty!</p><a href="javascript:void(0);" onclick="navigateTo('home')" class="link-primary">Continue Shopping</a></div>`;
        ...
        <div class="cart-item-details-grid">
          ...
          <div class="cart-item-details">
            ...
            <div class="product-quantity">
              <span>Quantity: <span class="js-quantity-label-${cartItem.productId}">${cartItem.quantity}</span></span>
              <span class="update-quantity-link link-primary js-update-link" data-product-id="${cartItem.productId}" style="margin-left:8px;cursor:pointer;">Update</span>
              <span class="delete-quantity-link link-primary js-delete-link" data-product-id="${cartItem.productId}" style="margin-left:8px;cursor:pointer;">Delete</span>
            </div>
            <div class="js-quantity-input-container-${cartItem.productId}" style="display:none;margin-top:8px;">
              <input type="number" min="1" max="99" value="${cartItem.quantity}" class="js-new-quantity-${cartItem.productId}" style="width:60px;padding:4px;border:1px solid #ccc;border-radius:4px;">
              <span class="link-primary js-save-link" data-product-id="${cartItem.productId}" style="margin-left:8px;cursor:pointer;">Save</span>
            </div>
          </div>
...
function attachCheckoutListeners() {
  ...
  document.querySelectorAll(".js-update-link").forEach(link => {
    link.addEventListener("click", () => {
      const c = document.querySelector(`.js-quantity-input-container-${link.dataset.productId}`);
  ...
  document.querySelectorAll(".js-save-link").forEach(link => {
    link.addEventListener("click", async () => {
      ...
      if (isNaN(qty) || qty < 1 || qty > 99) { alert("Enter a valid quantity (1-99)."); return; }
...
async function renderOrders() {
  ...
  if (orders.length === 0) {
    grid.innerHTML = `<div style="padding:30px;text-align:center;border:1px solid #ddd;border-radius:8px;"><p style="font-size:18px;margin-bottom:15px;font-weight:500;">No orders yet.</p><a href="javascript:void(0);" onclick="navigateTo('home')" class="link-primary" style="font-size:16px;">Start Shopping →</a></div>`;
    return;
  }
    ...
    items.forEach(item => {
      ...
      itemsHTML += `
        ...
        <div class="product-details">
          ...
          <div class="product-delivery-date">Arriving: ${item.delivery_date}</div>
        ...
        <div class="product-actions">
          <button class="track-package-button button-secondary js-track-package"
            data-item='${JSON.stringify({ name: item.product_name, image: item.product_image, quantity: item.quantity, deliveryDate: item.delivery_date, status: item.status || "Preparing" })}'>
            Track package
          </button>
        </div>`;
    });
...
function renderTrackingPage() {
  ...
  const config = STATUS_CONFIG[item.status] || STATUS_CONFIG["Preparing"];
...
window.onload = async function () {
  ...
  // Auth state changes (handles Google OAuth redirect)
    ...
    if (session) {
      ...
      if (currentUser.identities?.some(i => i.provider === "google")) {
        ...
        await db.from("profiles").upsert(
          { id: currentUser.id, full_name: fullName, email: currentUser.email || "" },
